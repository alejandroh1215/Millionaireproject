...
public class Question6 extends AppCompatActivity {
    ...
    public static int totalMoney = Question5.totalMoney;
    public static int totalRight = Question5.totalRight;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question.setText("A train is the hero of a classic children's book titled The Little Engine That what?");   //set the question

        AnsA.setText("Ran");  // set answer choices
        AnsB.setText("Never Stopped");
        AnsC.setText("Could");
        ...
        AnsC.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                Intent newQues = new Intent(getApplicationContext(), Question7.class);
                startActivity(newQues);
            }
        });
