...
public class Question3 extends AppCompatActivity {
    ...
    public static int totalMoney = Question2.totalMoney;
    public static int totalRight = Question2.totalRight;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question.setText("Where did Scotch whisky originate ?");   //set the question

        AnsA.setText("Wales");  // set answer choices
        AnsB.setText("Ireland");
        AnsC.setText("Scotland");
        ...
        AnsC.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                Intent newQues = new Intent(getApplicationContext(), Question4.class);
                startActivity(newQues);
            }
        });
